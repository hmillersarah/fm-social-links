...
- [EM vs REM vs PX](https://engageinteractive.co.uk/blog/em-vs-rem-vs-px) - This resource was helpful for understanding the use cases for em, rem, and px for CSS sizing.
